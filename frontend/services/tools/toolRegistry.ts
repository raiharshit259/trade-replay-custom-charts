...
const lineSchema = baseOptionSchema.filter((f) => !['font', 'textSize', 'textMaxWidth', 'bold', 'italic', 'align', 'textBackground', 'textBorder', 'textPadding', 'fibLevels', 'fibLabelMode', 'vwapInterval', 'positionLabelMode', 'brushSmoothness'].includes(String(f.key)));
const textSchema = baseOptionSchema.filter((f) => !['extendLeft', 'extendRight', 'rayMode', 'fibLevels', 'fibLabelMode', 'vwapInterval', 'positionLabelMode', 'brushSmoothness'].includes(String(f.key)));
const shapeSchema = baseOptionSchema.filter((f) => !['rayMode', 'fibLevels', 'fibLabelMode', 'vwapInterval', 'brushSmoothness'].includes(String(f.key)));
const brushSchema = baseOptionSchema.filter((f) => !['extendLeft', 'extendRight', 'rayMode', 'fibLevels', 'fibLabelMode', 'vwapInterval', 'positionLabelMode', 'font', 'textSize', 'textMaxWidth', 'bold', 'italic', 'align', 'textBackground', 'textBorder', 'textPadding'].includes(String(f.key)));
const fibSchema = baseOptionSchema.filter((f) => !['vwapInterval', 'positionLabelMode', 'brushSmoothness'].includes(String(f.key)));
const forecastingSchema = baseOptionSchema.filter((f) => !['fibLevels', 'fibLabelMode', 'brushSmoothness'].includes(String(f.key)));
...
export const toolDefinitions: ToolDefinition[] = [
  ...
  def({ id: 'longPosition', label: 'Long position', category: 'forecasting', subSection: 'Forecasting', family: 'position', iconKey: 'TrendingUp', capabilities: { anchors: 3, draggable: true, resizable: true, supportsText: true, supportsFill: true, supportsLevels: false }, optionsSchema: forecastingSchema }),
  def({ id: 'shortPosition', label: 'Short position', category: 'forecasting', subSection: 'Forecasting', family: 'position', iconKey: 'TrendingDown', capabilities: { anchors: 3, draggable: true, resizable: true, supportsText: true, supportsFill: true, supportsLevels: false }, optionsSchema: forecastingSchema }),
  def({ id: 'positionForecast', label: 'Position forecast', category: 'forecasting', subSection: 'Forecasting', family: 'position', iconKey: 'Activity', capabilities: { anchors: 3, draggable: true, resizable: true, supportsText: true, supportsFill: true, supportsLevels: false }, optionsSchema: forecastingSchema }),
  def({ id: 'barPattern', label: 'Bar pattern', category: 'forecasting', subSection: 'Forecasting', family: 'pattern', iconKey: 'Activity', capabilities: { anchors: 2, draggable: true, resizable: true, supportsText: false, supportsFill: false, supportsLevels: false }, optionsSchema: forecastingSchema }),
  def({ id: 'ghostFeed', label: 'Ghost feed', category: 'forecasting', subSection: 'Forecasting', family: 'pattern', iconKey: 'Waves', capabilities: { anchors: 2, draggable: true, resizable: true, supportsText: false, supportsFill: false, supportsLevels: false }, optionsSchema: forecastingSchema }),
  def({ id: 'sector', label: 'Sector', category: 'forecasting', subSection: 'Forecasting', family: 'shape', iconKey: 'Mountain', capabilities: { anchors: 2, draggable: true, resizable: true, supportsText: false, supportsFill: true, supportsLevels: false }, optionsSchema: forecastingSchema }),

  /* ── Forecasting → VOLUME-BASED ─────────────────────────────── */
  def({ id: 'anchoredVwap', label: 'Anchored VWAP', category: 'forecasting', subSection: 'Volume-based', family: 'line', iconKey: 'Activity', capabilities: { anchors: 1, draggable: true, resizable: false, supportsText: false, supportsFill: false, supportsLevels: false }, optionsSchema: forecastingSchema }),
  def({ id: 'fixedRangeVolumeProfile', label: 'Fixed range volume profile', category: 'forecasting', subSection: 'Volume-based', family: 'measure', iconKey: 'Activity', capabilities: { anchors: 2, draggable: true, resizable: true, supportsText: false, supportsFill: true, supportsLevels: false }, optionsSchema: forecastingSchema }),
  def({ id: 'anchoredVolumeProfile', label: 'Anchored volume profile', category: 'forecasting', subSection: 'Volume-based', family: 'measure', iconKey: 'Activity', capabilities: { anchors: 1, draggable: true, resizable: false, supportsText: false, supportsFill: true, supportsLevels: false }, optionsSchema: forecastingSchema }),

  /* ── Forecasting → MEASURERS ────────────────────────────────── */
  def({ id: 'priceRange', label: 'Price range', category: 'forecasting', subSection: 'Measurers', family: 'measure', iconKey: 'Ruler', capabilities: { anchors: 2, draggable: true, resizable: true, supportsText: false, supportsFill: false, supportsLevels: false }, optionsSchema: forecastingSchema }),
  def({ id: 'dateRange', label: 'Date range', category: 'forecasting', subSection: 'Measurers', family: 'measure', iconKey: 'Ruler', capabilities: { anchors: 2, draggable: true, resizable: true, supportsText: false, supportsFill: false, supportsLevels: false }, optionsSchema: forecastingSchema }),
  def({ id: 'dateAndPriceRange', label: 'Date and price range', category: 'forecasting', subSection: 'Measurers', family: 'measure', iconKey: 'Ruler', capabilities: { anchors: 2, draggable: true, resizable: true, supportsText: false, supportsFill: false, supportsLevels: false }, optionsSchema: forecastingSchema }),

  /* Legacy measure/zoom aliases */
  def({ id: 'measure', label: 'Measure', category: 'forecasting', subSection: 'Measurers', family: 'measure', iconKey: 'Ruler', capabilities: { anchors: 2, draggable: true, resizable: true, supportsText: false, supportsFill: false, supportsLevels: false }, optionsSchema: forecastingSchema }),
  def({ id: 'zoom', label: 'Zoom', category: 'forecasting', subSection: 'Measurers', family: 'measure', iconKey: 'ZoomIn', capabilities: { anchors: 2, draggable: true, resizable: true, supportsText: false, supportsFill: false, supportsLevels: false }, optionsSchema: forecastingSchema }),

  /* ── Brush → BRUSHES ────────────────────────────────────────── */
  def({ id: 'brush', label: 'Brush', category: 'brush', subSection: 'Brushes', family: 'shape', iconKey: 'PencilLine', capabilities: { anchors: 2, draggable: true, resizable: true, supportsText: false, supportsFill: false, supportsLevels: false }, optionsSchema: brushSchema }),
  def({ id: 'highlighter', label: 'Highlighter', category: 'brush', subSection: 'Brushes', family: 'shape', iconKey: 'PencilLine', capabilities: { anchors: 2, draggable: true, resizable: true, supportsText: false, supportsFill: false, supportsLevels: false }, optionsSchema: brushSchema }),
  ...
  def({ id: 'path', label: 'Path', category: 'brush', subSection: 'Shapes', family: 'line', iconKey: 'PencilLine', capabilities: { anchors: 2, draggable: true, resizable: true, supportsText: false, supportsFill: false, supportsLevels: false }, optionsSchema: brushSchema }),
  ...
  def({ id: 'polyline', label: 'Polyline', category: 'brush', subSection: 'Shapes', family: 'line', iconKey: 'PencilLine', capabilities: { anchors: 2, draggable: true, resizable: true, supportsText: false, supportsFill: false, supportsLevels: false }, optionsSchema: brushSchema }),
  ...
  def({ id: 'curveTool', label: 'Curve', category: 'brush', subSection: 'Shapes', family: 'line', iconKey: 'Waves', capabilities: { anchors: 2, draggable: true, resizable: true, supportsText: false, supportsFill: false, supportsLevels: false }, optionsSchema: brushSchema }),
  def({ id: 'doubleCurve', label: 'Double curve', category: 'brush', subSection: 'Shapes', family: 'line', iconKey: 'Waves', capabilities: { anchors: 2, draggable: true, resizable: true, supportsText: false, supportsFill: false, supportsLevels: false }, optionsSchema: brushSchema }),
